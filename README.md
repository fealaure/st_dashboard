...
- **Fontes de dados**: RSS via [SimplePie](https://www.simplepie.org/) (IGN, Game Informer, Eurogamer, VGC, Kotaku, Insider Gaming) e [IGDB](https://api.igdb.com/) pros lançamentos
